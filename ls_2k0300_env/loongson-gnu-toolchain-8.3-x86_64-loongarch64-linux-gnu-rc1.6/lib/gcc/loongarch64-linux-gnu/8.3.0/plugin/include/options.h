...
extern unsigned int recip_mask;
#else
  unsigned int x_recip_mask;
...
#endif
#ifdef GENERATOR_FILE
extern void *la_deferred_options;
#else
  void *x_la_deferred_options;
#define la_deferred_options global_options.x_la_deferred_options
#endif
#ifdef GENERATOR_FILE
extern int loongarch_force_drap;
#else
  int x_loongarch_force_drap;
#define loongarch_force_drap global_options.x_loongarch_force_drap
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int loongarch_vector_access_cost;
#else
  int x_loongarch_vector_access_cost;
#define loongarch_vector_access_cost global_options.x_loongarch_vector_access_cost
#endif
#ifdef GENERATOR_FILE
extern int loongarch_recip;
#else
  int x_loongarch_recip;
#define loongarch_recip global_options.x_loongarch_recip
#endif
#ifdef GENERATOR_FILE
extern const char *loongarch_recip_name;
#else
  const char *x_loongarch_recip_name;
#define loongarch_recip_name global_options.x_loongarch_recip_name
#endif
#ifdef GENERATOR_FILE
extern int la_opt_simd;
#else
  int x_la_opt_simd;
#define la_opt_simd global_options.x_la_opt_simd
#endif
#ifdef GENERATOR_FILE
extern int loongarch_stack_realign;
#else
  int x_loongarch_stack_realign;
#define loongarch_stack_realign global_options.x_loongarch_stack_realign
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern const char *loongarch_veclibabi_name;
#else
  const char *x_loongarch_veclibabi_name;
#define loongarch_veclibabi_name global_options.x_loongarch_veclibabi_name
#endif
#ifdef GENERATOR_FILE
...
struct GTY(()) cl_target_option
{
  ...
  int x_la_opt_simd;
  int x_la_opt_cpu_tune;
  signed char x_TARGET_COND_MOVE_FLOAT;
  signed char x_TARGET_COND_MOVE_INT;
  signed char x_loongarch_force_drap;
  signed char x_loongarch_recip;
  signed char x_loongarch_stack_realign;
  signed char x_TARGET_STRICT_ALIGN;
  signed char x_TARGET_VECARG;
};
...
#define MASK_LP64 (1U << 0)
#define OPTION_MASK_ANDROID (1U << 0)
#define MASK_CHECK_ZERO_DIV (1U << 1)
#define MASK_MEMCPY (1U << 2)

#define TARGET_LP64 ((target_flags & MASK_LP64) != 0)
#define TARGET_LP64_P(target_flags) (((target_flags) & MASK_LP64) != 0)
...
enum opt_code
{
  ...
  OPT_mforce_drap = 1248,                    /* -mforce-drap */
  OPT_mfpu_ = 1249,                          /* -mfpu= */
  /* OPT_mfpu_0 = 1250, */                   /* -mfpu=0 */
  /* OPT_mfused_madd = 1251, */              /* -mfused-madd */
  OPT_mglibc = 1252,                         /* -mglibc */
  OPT_mlasx = 1253,                          /* -mlasx */
  OPT_mlsx = 1254,                           /* -mlsx */
  OPT_mmax_inline_memcpy_size_ = 1255,       /* -mmax-inline-memcpy-size= */
  OPT_mmemcpy = 1256,                        /* -mmemcpy */
  OPT_mmemvec_cost_ = 1257,                  /* -mmemvec-cost= */
  OPT_mmusl = 1258,                          /* -mmusl */
  OPT_mrecip = 1259,                         /* -mrecip */
  OPT_mrecip_ = 1260,                        /* -mrecip= */
  OPT_msimd_ = 1261,                         /* -msimd= */
  OPT_msingle_float = 1262,                  /* -msingle-float */
  OPT_msoft_float = 1263,                    /* -msoft-float */
  OPT_mstackrealign = 1264,                  /* -mstackrealign */
  OPT_mstrict_align = 1265,                  /* -mstrict-align */
  OPT_mtune_ = 1266,                         /* -mtune= */
  OPT_muclibc = 1267,                        /* -muclibc */
  OPT_mvecarg = 1268,                        /* -mvecarg */
  OPT_mveclibabi_ = 1269,                    /* -mveclibabi= */
  OPT_n = 1270,                              /* -n */
  ...
  OPT_nophoboslib = 1276,                    /* -nophoboslib */
  ...
  OPT_o = 1281,                              /* -o */
  OPT_p = 1282,                              /* -p */
  OPT_pass_exit_codes = 1283,                /* -pass-exit-codes */
  /* OPT_pedantic = 1284, */                 /* -pedantic */
  OPT_pedantic_errors = 1285,                /* -pedantic-errors */
  OPT_pg = 1286,                             /* -pg */
  OPT_pie = 1287,                            /* -pie */
  OPT_pipe = 1288,                           /* -pipe */
  OPT_posix = 1289,                          /* -posix */
  OPT_print_file_name_ = 1290,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1291,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1292,          /* -print-multi-directory */
  OPT_print_multi_lib = 1293,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1294,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1295,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1296,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1297,               /* -print-prog-name= */
  OPT_print_search_dirs = 1298,              /* -print-search-dirs */
  OPT_print_sysroot = 1299,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1300,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1301,                        /* -profile */
  OPT_pthread = 1302,                        /* -pthread */
  OPT_quiet = 1303,                          /* -quiet */
  OPT_r = 1304,                              /* -r */
  OPT_rdynamic = 1305,                       /* -rdynamic */
  OPT_remap = 1306,                          /* -remap */
  OPT_s = 1307,                              /* -s */
  OPT_save_temps = 1308,                     /* -save-temps */
  OPT_save_temps_ = 1309,                    /* -save-temps= */
  OPT_shared = 1310,                         /* -shared */
  OPT_shared_libgcc = 1311,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1312,               /* -shared-libphobos */
  ...
  OPT_static_libgfortran = 1318,             /* -static-libgfortran */
  OPT_static_libgo = 1319,                   /* -static-libgo */
  OPT_static_liblsan = 1320,                 /* -static-liblsan */
  OPT_static_libmpx = 1321,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1322,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1323,               /* -static-libphobos */
  OPT_static_libstdc__ = 1324,               /* -static-libstdc++ */
  OPT_static_libtsan = 1325,                 /* -static-libtsan */
  OPT_static_libubsan = 1326,                /* -static-libubsan */
  OPT_static_pie = 1327,                     /* -static-pie */
  /* OPT_std_c__03 = 1328, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1329, */                /* -std=c++0x */
  OPT_std_c__11 = 1330,                      /* -std=c++11 */
  OPT_std_c__14 = 1331,                      /* -std=c++14 */
  OPT_std_c__17 = 1332,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1333, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1334, */                /* -std=c++1z */
  OPT_std_c__2a = 1335,                      /* -std=c++2a */
  OPT_std_c__98 = 1336,                      /* -std=c++98 */
  OPT_std_c11 = 1337,                        /* -std=c11 */
  OPT_std_c17 = 1338,                        /* -std=c17 */
  /* OPT_std_c18 = 1339, */                  /* -std=c18 */
  /* OPT_std_c1x = 1340, */                  /* -std=c1x */
  /* OPT_std_c89 = 1341, */                  /* -std=c89 */
  OPT_std_c90 = 1342,                        /* -std=c90 */
  OPT_std_c99 = 1343,                        /* -std=c99 */
  /* OPT_std_c9x = 1344, */                  /* -std=c9x */
  OPT_std_f2003 = 1345,                      /* -std=f2003 */
  OPT_std_f2008 = 1346,                      /* -std=f2008 */
  OPT_std_f2008ts = 1347,                    /* -std=f2008ts */
  OPT_std_f2018 = 1348,                      /* -std=f2018 */
  OPT_std_f95 = 1349,                        /* -std=f95 */
  OPT_std_gnu = 1350,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1351, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1352, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1353,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1354,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1355,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1356, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1357, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1358,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1359,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1360,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1361,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1362, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1363, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1364, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1365,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1366,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1367, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1368, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1369,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1370, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1371, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1372, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1373, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1374, */         /* -std=iso9899:2018 */
